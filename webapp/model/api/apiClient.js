sap.ui.define([], () => {
    ...
    // Helper function to determine the API URL based on the current environment.
    ...
    // Helper function to fetch JSON data from the API, handling errors and parsing the response.
