...
class Settings:
    ...
    local_timezone: str = DEFAULT_WEATHER_LOCATION.timezone
    weather_location: WeatherLocation = field(default_factory=lambda: DEFAULT_WEATHER_LOCATION)
    weather_refresh_on_startup: bool = True
    sensor_source: str = SensorSource.DEFAULT.value
...
def get_settings() -> Settings:
    return Settings(
        ...
        sensor_source=os.getenv("SENSOR_SOURCE", SensorSource.DEFAULT.value),
