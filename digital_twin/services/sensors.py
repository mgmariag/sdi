...
from digital_twin.db.sensor_repository import SensorRepository
from tools.sensor_readings import (
...
class SensorService:
    ...
    def has_data(self, source: str, pot_ids: list[int] | None = None) -> bool:
        return get_sensor_availability(source=source, pot_ids=pot_ids) is not None
