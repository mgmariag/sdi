...
from digital_twin.application.actuators.feedback import ActuationFeedbackService
...
class IrrigationActuationService:
    ...
    def store_prescriptions(
        self,
        prescriptions: list[PreparedIrrigationPrescription] | None = None,
        target_date: date | None = None,
        dispatched_at: datetime | None = None,
    ) -> dict[str, Any]:
        dispatched_at = dispatched_at or self.clock.now()
