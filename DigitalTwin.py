...
class DigitalTwin:
    def __init__(self, threshold=35, hysteresis_width=0, irrigation_flow_l_per_min=1.0):
        ...
        Args:
            ...
            irrigation_flow_l_per_min (float): assumed irrigation flow rate for usage estimates.
        """
        ...
        self.irrigation_flow_l_per_min = irrigation_flow_l_per_min
    ...
    def get_state(self):
        return {
            ...
            "irrigation_flow_l_per_min": self.irrigation_flow_l_per_min,
